#ifndef __PROTOCOL_COMPLETED_H
#define __PROTOCOL_COMPLETED_H
#include <cstdint>
#include <cstring>
#include <cmath>
// --- Communication Types ---
...
namespace ModelScale
{
    ...
    namespace RS01
    {
        ...
        constexpr double TORQUE = 17.0;         // ±17 Nm
        constexpr double KP = 500.0;            // 0-500 Nm/rad
        constexpr double KD = 5.0;              // 0-5 Nm/rad
    }
    namespace RS02
    {
        constexpr double POSITION = 4.0 * M_PI; // ±4π radians
    ...
    {
        constexpr double POSITION = 4.0 * M_PI; // ±4π radians
        constexpr double VELOCITY = 15.0;       // ±15 rad/s
        constexpr double TORQUE = 120.0;        // ±120 Nm
        constexpr double KP = 5000.0;           // 0-5000 Nm/rad
        constexpr double KD = 100.0;            // 0-100 Nm/rad/s
    }
}
